...
cmsRun stepB.py print doNoFilter=False doCut='ptByPt(0)>0' selection=Tight doMuonIsoId=True doEleIsoId=True runPUPPISequence=False maxEvents=${EVENTS} inputFiles=${MYFILE}
