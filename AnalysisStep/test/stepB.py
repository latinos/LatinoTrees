...
if not isMC :
    setattr(stepBTree.variables, "std_vector_trigger",           cms.string("selectedRateTrigger/55") )
    setattr(stepBTree.variables, "std_vector_trigger_prescale",  cms.string("selectedRateTriggerPrescale/55") )
    setattr(stepBTree.variables, "std_vector_trigger_L1min_prescale",  cms.string("selectedRateTriggerL1minPrescale/55") )
    setattr(stepBTree.variables, "std_vector_trigger_L1max_prescale",  cms.string("selectedRateTriggerL1maxPrescale/55") )
