...
config.General.workArea     = 'crab_projects_08Jan'  # Make sure you set this parameter
...
config.Data.outLFNDirBase = '/store/group/phys_higgs/cmshww/amassiro/RunII/08Jan/'
