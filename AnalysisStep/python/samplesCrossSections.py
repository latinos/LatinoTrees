...
# ttDM
ttDM0001scalar0010'] .extend( ['xsec=19.59'         , 'kfact=1.000', 'ref=J'] )
#ttDM0001scalar0020'] .extend( ['xsec=10.48'         , 'kfact=1.000', 'ref=J'] )
ttDM0001scalar0050'] .extend( ['xsec=2.941'         , 'kfact=1.000', 'ref=J'] )
ttDM0001scalar0100'] .extend( ['xsec=0.6723'        , 'kfact=1.000', 'ref=J'] )
ttDM0001scalar0200'] .extend( ['xsec=0.09327'       , 'kfact=1.000', 'ref=J'] )
ttDM0001scalar0300'] .extend( ['xsec=0.0295'        , 'kfact=1.000', 'ref=J'] ) 
ttDM0001scalar0500'] .extend( ['xsec=0.00518'       , 'kfact=1.000', 'ref=J'] )  
#ttDM0001scalar1000'] .extend( ['xsec=0.0003687'     , 'kfact=1.000', 'ref=J'] ) 
#ttDM0001scalar2000'] .extend( ['xsec=0.00001034'    , 'kfact=1.000', 'ref=J'] )  
#ttDM0001scalar5000'] .extend( ['xsec=0.0000000617'  , 'kfact=1.000', 'ref=J'] )
ttDM0010scalar0010'] .extend( ['xsec=0.09487'       , 'kfact=1.000', 'ref=J'] ) 
#ttDM0010scalar0015'] .extend( ['xsec=0.1202'        , 'kfact=1.000', 'ref=J'] )
ttDM0010scalar0050'] .extend( ['xsec=2.942'         , 'kfact=1.000', 'ref=J'] )  
ttDM0010scalar0100'] .extend( ['xsec=0.6732'        , 'kfact=1.000', 'ref=J'] ) 
#ttDM0010scalar5000'] .extend( ['xsec=0.00000006138' , 'kfact=1.000', 'ref=J'] )
#ttDM0050scalar0010'] .extend( ['xsec=0.001906'      , 'kfact=1.000', 'ref=J'] ) 
ttDM0050scalar0050'] .extend( ['xsec=0.002329'      , 'kfact=1.000', 'ref=J'] )  
#ttDM0050scalar0095'] .extend( ['xsec=0.006558'      , 'kfact=1.000', 'ref=J'] ) 
ttDM0050scalar0200'] .extend( ['xsec=0.09224'       , 'kfact=1.000', 'ref=J'] )  
ttDM0050scalar0300'] .extend( ['xsec=0.02901'       , 'kfact=1.000', 'ref=J'] )  
#ttDM0050scalar5000'] .extend( ['xsec=0.00000005616' , 'kfact=1.000', 'ref=J'] )
#ttDM0150scalar0010'] .extend( ['xsec=0.00008634'    , 'kfact=1.000', 'ref=J'] )  
ttDM0150scalar0200'] .extend( ['xsec=0.00013'       , 'kfact=1.000', 'ref=J'] ) 
#ttDM0150scalar0295'] .extend( ['xsec=0.000394'      , 'kfact=1.000', 'ref=J'] )  
#ttDM0150scalar0500'] .extend( ['xsec=0.003754'      , 'kfact=1.000', 'ref=J'] ) 
#ttDM0150scalar5000'] .extend( ['xsec=0.00000004162' , 'kfact=1.000', 'ref=J'] )
#ttDM0500scalar0010'] .extend( ['xsec=0.0000007356'  , 'kfact=1.000', 'ref=J'] )  
ttDM0500scalar0500'] .extend( ['xsec=0.0000009894'  , 'kfact=1.000', 'ref=J'] ) 
#ttDM0500scalar0995'] .extend( ['xsec=0.0000073'     , 'kfact=1.000', 'ref=J'] )
#ttDM0500scalar2000'] .extend( ['xsec=0.000005808'   , 'kfact=1.000', 'ref=J'] )  
#ttDM0500scalar5000'] .extend( ['xsec=0.000001048'   , 'kfact=1.000', 'ref=J'] )  
#ttDM1000scalar0010'] .extend( ['xsec=0.000000006607', 'kfact=1.000', 'ref=J'] )  
#ttDM1000scalar1000'] .extend( ['xsec=0.000000009433', 'kfact=1.000', 'ref=J'] )
#ttDM1000scalar1995'] .extend( ['xsec=0.0000001108'  , 'kfact=1.000', 'ref=J'] )
#ttDM1000scalar2000'] .extend( ['xsec=0.0000000017'  , 'kfact=1.000', 'ref=J'] )

ttDM0001pseudo0010'] .extend( ['xsec=0.4409'        , 'kfact=1.000', 'ref=J'] )
ttDM0001pseudo0020'] .extend( ['xsec=0.3992'        , 'kfact=1.000', 'ref=J'] )
ttDM0001pseudo0050'] .extend( ['xsec=0.3032'        , 'kfact=1.000', 'ref=J'] )
ttDM0001pseudo0100'] .extend( ['xsec=0.1909'        , 'kfact=1.000', 'ref=J'] )
ttDM0001pseudo0200'] .extend( ['xsec=0.0836'        , 'kfact=1.000', 'ref=J'] )
#ttDM0001pseudo0300'] .extend( ['xsec=0.03999'       , 'kfact=1.000', 'ref=J'] )
ttDM0001pseudo0500'] .extend( ['xsec=0.005408'      , 'kfact=1.000', 'ref=J'] )
#ttDM0001pseudo1000'] .extend( ['xsec=0.0003973'     , 'kfact=1.000', 'ref=J'] )
#ttDM0001pseudo2000'] .extend( ['xsec=0.00001087'    , 'kfact=1.000', 'ref=J'] )
#ttDM0001pseudo5000'] .extend( ['xsec=0.00000007022' , 'kfact=1.000', 'ref=J'] )
#ttDM0010pseudo0010'] .extend( ['xsec=0.01499'       , 'kfact=1.000', 'ref=J'] )
#ttDM0010pseudo0015'] .extend( ['xsec=0.3034'        , 'kfact=1.000', 'ref=J'] )
#ttDM0010pseudo0050'] .extend( ['xsec=0.1901'        , 'kfact=1.000', 'ref=J'] )
ttDM0010pseudo0100'] .extend( ['xsec=0.00000007023' , 'kfact=1.000', 'ref=J'] ) 
#ttDM0010pseudo5000'] .extend( ['xsec=0.01863'       , 'kfact=1.000', 'ref=J'] )
#ttDM0050pseudo0010'] .extend( ['xsec=0.002444'      , 'kfact=1.000', 'ref=J'] )
#ttDM0050pseudo0050'] .extend( ['xsec=0.002979'      , 'kfact=1.000', 'ref=J'] )
#ttDM0050pseudo0095'] .extend( ['xsec=0.08382'       , 'kfact=1.000', 'ref=J'] )
ttDM0050pseudo0200'] .extend( ['xsec=0.03989'       , 'kfact=1.000', 'ref=J'] )
#ttDM0050pseudo0300'] .extend( ['xsec=0.00000006831' , 'kfact=1.000', 'ref=J'] ) 
#ttDM0050pseudo5000'] .extend( ['xsec=0.01067'       , 'kfact=1.000', 'ref=J'] )
#ttDM0150pseudo0010'] .extend( ['xsec=0.0002364'     , 'kfact=1.000', 'ref=J'] )
ttDM0150pseudo0200'] .extend( ['xsec=0.0004124'     , 'kfact=1.000', 'ref=J'] )
#ttDM0150pseudo0295'] .extend( ['xsec=0.004611'      , 'kfact=1.000', 'ref=J'] )
ttDM0150pseudo0500'] .extend( ['xsec=0.000000057'   , 'kfact=1.000', 'ref=J'] )
#ttDM0150pseudo5000'] .extend( ['xsec=0.003365'      , 'kfact=1.000', 'ref=J'] )
#ttDM0500pseudo0010'] .extend( ['xsec=0.000002279'   , 'kfact=1.000', 'ref=J'] )
#ttDM0500pseudo0500'] .extend( ['xsec=0.000003275'   , 'kfact=1.000', 'ref=J'] )
#ttDM0500pseudo0995'] .extend( ['xsec=0.000007611'   , 'kfact=1.000', 'ref=J'] )
#ttDM0500pseudo2000'] .extend( ['xsec=0.00000001867' , 'kfact=1.000', 'ref=J'] ) 
#ttDM0500pseudo5000'] .extend( ['xsec=0.00006171'    , 'kfact=1.000', 'ref=J'] )
#ttDM1000pseudo0010'] .extend( ['xsec=0.000000026'   , 'kfact=1.000', 'ref=J'] )
#ttDM1000pseudo1000'] .extend( ['xsec=0.00000003933' , 'kfact=1.000', 'ref=J'] ) 
#ttDM1000pseudo1995'] .extend( ['xsec=0.000000003536', 'kfact=1.000', 'ref=J'] ) 
#ttDM1000pseudo2000'] .extend( ['xsec=0.000001103'   , 'kfact=1.000', 'ref=J'] )  
