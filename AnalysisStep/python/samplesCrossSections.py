...
samples['WZTo3LNu_mllmin01']	        .extend( ['xsec=35.2665',	'kfact=1.000',		'ref=X'] ) # From WZTo3LNu comparision
...
samples['T2tt_mStop150to250'] .extend( ['xsec=1.000','kfact=1.000',   'ref=X'] )
samples['T2tt_mStop250to350'] .extend( ['xsec=1.000','kfact=1.000',   'ref=X'] )
samples['T2tt_mStop350to400'] .extend( ['xsec=1.000','kfact=1.000',   'ref=X'] )
samples['T2tt_mStop400to1200'] .extend( ['xsec=1.000','kfact=1.000',   'ref=X'] )
