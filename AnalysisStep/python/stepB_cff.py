...
# +(" && triggerMatchingCut('DATASET')")
    ...
    variables = cms.PSet(
        ...
        std_vector_lepton_bdt          = cms.string("leptBdtByPt"),
        std_vector_lepton_lh           = cms.string("leptLHByPt"),
...
# pmvamet = cms.string("projMvaMet"),
        ...
        #bdt1   = cms.string("leptBdtByPt(0)"),  # Deprecated, use std_vector_lepton_bdt
        #bdt2   = cms.string("leptBdtByPt(1)"),  # Deprecated, use std_vector_lepton_bdt
        #bdt3   = cms.string("leptBdtByPt(2)"),  # Deprecated, use std_vector_lepton_bdt
        #bdt4   = cms.string("leptBdtByPt(3)"),  # Deprecated, use std_vector_lepton_bdt
        #lh1    = cms.string("leptLHByPt(0)"),   # Deprecated, use std_vector_lepton_lh
        #lh2    = cms.string("leptLHByPt(1)"),   # Deprecated, use std_vector_lepton_lh
        #lh3    = cms.string("leptLHByPt(2)"),   # Deprecated, use std_vector_lepton_lh
        #lh4    = cms.string("leptLHByPt(3)"),   # Deprecated, use std_vector_lepton_lh
