...
# +(" && triggerMatchingCut('DATASET')")
	...
	std_vector_lepton_pt            = cms.string("ptByPt"),
        ...
        std_vector_lepton_chargedHadronIso03   =     cms.string("chargedHadronIso03ByPt"),
        std_vector_lepton_neutralHadronIso03   =     cms.string("neutralHadronIso03ByPt"),
        std_vector_lepton_photonIso03          =     cms.string("photonIso03ByPt"),
        std_vector_lepton_sumPUPt03            =     cms.string("sumPUPt03ByPt"), 
	...
	dmZllReco = cms.string("dmZllReco"),
        ...
        jetRhoCentralNeutral = cms.string("getJetRhoCentralNeutralIso()"),
        ...
        std_vector_lepton_eleIdVeto    = cms.string("leptIdByPt(\"egmGsfElectronIDs:cutBasedElectronID-Summer16-80X-V1-veto\",\"\""),
        std_vector_lepton_eleIdLoose   = cms.string("leptIdByPt(\"egmGsfElectronIDs:cutBasedElectronID-Summer16-80X-V1-loose\",\"\""),
        std_vector_lepton_eleIdMedium  = cms.string("leptIdByPt(\"egmGsfElectronIDs:cutBasedElectronID-Summer16-80X-V1-medium\",\"\""),
        std_vector_lepton_eleIdTight   = cms.string("leptIdByPt(\"egmGsfElectronIDs:cutBasedElectronID-Summer16-80X-V1-tight\",\"\""),
...
def addBTaggingVariables(pt,dzCut=99999):
    if hasattr(pt,"variables"):
        ...
        pt.variables.std_vector_jet_DeepCSVB  = cms.string("jetDeepCSVBByPt")
...
def addLHEVariables(process,pt):
    if hasattr(pt,"variables"):
        ...
        setattr(pt.variables, "topLHEpt"  , cms.string("partonLHEPt(6)")),
        setattr(pt.variables, "topLHEeta" , cms.string("partonLHEEta(6)")),
        setattr(pt.variables, "topLHEphi" , cms.string("partonLHEPhi(6)")),
        setattr(pt.variables, "topLHEmass", cms.string("partonLHEmass(6)")),

        setattr(pt.variables, "antitopLHEpt"  , cms.string("partonLHEPt(-6)")),
        setattr(pt.variables, "antitopLHEeta" , cms.string("partonLHEEta(-6)")),
        setattr(pt.variables, "antitopLHEphi" , cms.string("partonLHEPhi(-6)")),
        setattr(pt.variables, "antitopLHEmass", cms.string("partonLHEmass(-6)")),
...
def addGenVariables(process,pt):
    if hasattr(pt,"variables"):
        ...
        setattr(pt.variables, "std_vector_DarkMatterGen_pt",    cms.string("GenDarkMatterPt")),
