...
# +(" && triggerMatchingCut('DATASET')")
    ...
    variables = cms.PSet(
        ...
        metPfRaw = cms.string("pfRawMet"),
        metPfRawSumEt = cms.string("pfRawSumEt"),
        metPfRawPhi = cms.string("pfRawMetPhi"),
        metPfType1 = cms.string("pfType1Met"),
        metPfType1Phi = cms.string("pfType1MetPhi"),
        metPfType1SumEt = cms.string("pfType1SumEt"),
        metPfType1JetUp = cms.string("pfType1MetJetUp"),
        metPfType1JetDn = cms.string("pfType1MetJetDn"),
        metPfType1MuonUp = cms.string("pfType1MetMuonUp"),
        metPfType1MuonDn = cms.string("pfType1MetMuonDn"),
        metPfType1ElecUp = cms.string("pfType1MetElecUp"),
        metPfType1ElecDn = cms.string("pfType1MetElecDn"),
        metPfProj = cms.string("projPfMet"),
        metPuppi = cms.string("pupMet"),
        metTtrk = cms.string("trkMet"),
        metTtrkPhi = cms.string("trkMetphi"),
        metPfNoHf = cms.string("pfMetNoHf"),
